...
(select deptno from emp where ename = '이문세');  -- <--서브쿼리
...
-- 문제. 급여가 500을 초과하는 사원과 같은 부서(deptno) 에 근무하는 직원을 출력하시오.
select 

-- 문제. 서브쿼리를 이용하여 급여가 500을 초과하는 사원과 같은 부서(deptno) 에 근무하는 직원을 출력하시오.
