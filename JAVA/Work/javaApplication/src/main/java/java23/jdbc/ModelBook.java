...
public class ModelBook {
   ...
   public String toString() {
       return "ModelBook [bookid=" + bookid + ", bookname=" + bookname
               ...
               + ", dtm=" + dtm + ", use_yn=" + use_yn + ", authid=" + authid
               + "]";
   }
   //constructor
   public ModelBook() {
   ...
   public ModelBook(Integer bookid, String bookname, String publisher, String year,
           Integer price, Date dtm, Boolean use_yn, Integer authid) {
       super();
       this.bookid = bookid;
       this.bookname = bookname;
       this.publisher = publisher;
