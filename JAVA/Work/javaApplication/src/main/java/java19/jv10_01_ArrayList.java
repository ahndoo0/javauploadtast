...
//        list = new Stack<>();
        ...
        System.out.println("S: 검색 첫번쨰 APPLE 방번호>> " + pos );    //0
        ...
        System.out.println("APPLE 이 몇개 있나요? "+count);
         ...
         */
        System.out.print("P : 변환된 배열을 for each 문으로 출력 ");
         ...
         */
        list.removeAll(list);
        System.out.println("list의 모든 값을 삭제 >> " + list);
