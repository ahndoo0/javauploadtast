...
public class jv08_01_String메서드 {
    ...
    public static void main(String[] args) {
        ...
        String g = prov.substring(0, prov.length() - 1);
        // String g = prov.substring(0,12);
        ...
        boolean conrains = prov.contains("Dog");
        System.out.println(conrains);
        
        // 문자열 치환 : replace()
        // Dog --> Cat 으로 바꾸시오
        String cat = prov.replace("Dog", "Cat");
        System.out.println(cat);
        
        // prov 문자열에 Dog가 들어가 있으면 Cat으로 바꾸어 출력하고
        // 아니면 prov 출력하시오.
        
        if (prov.contains("Dog")) {
            cat = prov.replace("Dog", "Cat");
            System.out.println(cat);
        } else {
