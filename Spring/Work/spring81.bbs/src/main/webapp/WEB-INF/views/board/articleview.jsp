...
<head>
    ...
    <script>
        $(document).ready( function(event){
        	...
        	$('#addComment  input[type="button"]').click( function(exent){
        ...
        <div id="content" style="min-height: 800px;">
            ...
            <div id="bbs">
            	...
            	<div id="view-menu">
            		...
            		<div class="fr">
            		<c:if test="${nextArticle != null }">		
            			<input type="button" value="다음글" onclick="javascript:goView( ${nextArticle.articleno } );" />
            		</c:if>
            		<c:if test="${prevArticle != null }">			
            			<input type="button" value="이전글" onclick="javascript:goView( ${prevArticle.articleno } );" />
            		</c:if>
