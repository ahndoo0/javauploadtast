...
<script>
        $(document).ready( function(event){
        	...
        	$('#signUpForm input[type="submit"]').click( function(e) { 
        		...
        		// 패스워드 일치 여부 확인.
        		if ($('.req_input[name="passwd"]').val() !== $('.req_input[name="confirm"]').val()) {
        			alert('비밀번호가 일치 하지 않습니다 .');
        			$('.req_input[name="passwd"]').val("");
                    $('.req_input[name="confirm"]').val("");
        			return false;
                     }else if ($('.req_input[name="passwd"]').val() == $('.req_input[name="confirm"]').val()) {
                    	    $('#signUpForm').submit();
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="width: 390px"><input
                                ...
                                style="width: 70%;" id="userid"
                                class="req_input" /> <input
