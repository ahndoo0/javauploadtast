package com.spring61.rest.board.model;
...
public String toString() {
    return "ModelArticle [articleno=" + articleno + ", boardcd=" + boardcd
            ...
            + ", hit=" + hit + ", regdate=" + regdate + ", countgood="
            + countgood + ", countbad=" + countbad + ", UseYN=" + UseYN
...
public ModelArticle(Integer articleno, String boardcd, String title,
        ...
        Integer countgood, Integer countbad, Boolean useYN, String insertUID,
