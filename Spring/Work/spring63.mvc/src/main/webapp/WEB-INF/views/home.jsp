...
<body>  
    ...
    <a href="spring/querystring2?name=test2&phone=12442" target="_blank">/spring/querystring2?name=test2&phone=12442</a> <br />
    ...
    <a href="spring/login" target="_blank">@RequestParam 을 이용한 /spring/loginget</a> <br /> 
    <hr>
