...
public class TestPageHelper {
    ...
    public void test02_paging() {
        ...
        //ListNo
        assertEquals(paging.getListNo(), 50); // 1000 - 20*(26-1)
        ...
        //endRecord
        assertEquals(paging.getEndRecord(), 501); // 20*(26-1) + 1
        
        //startRecord
        assertEquals(paging.getStartRecord(), 520); // 20*(26-1) + 20
